...
fn complete_line<H: Helper>(
    ...
    if candidates.is_empty() {
        ...
        // WAASH patch (FISH-like tab completion): show the completion list on
        // the FIRST Tab press instead of requiring a second Tab. The stock
        // code waited for a second Tab here. page_completions() prints the
        // grid (with --More-- paging) and restores the prompt at the end.
